...
[,bash]
----
coreos-installer iso customize --network-keyfile vlan100.nmconnection -o custom-rhcos.iso rhcos-live.iso
----
...
https://mirror.openshift.com/pub/openshift-v4/dependencies/rhcos/latest/rhcos-installer-iso.x86_64.iso
