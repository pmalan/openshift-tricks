...
Install relevant binaries on connected, and disconnected hosts. 

TIP: All configuration was done for OpenShift 4.16.x. Update according to your target version.
